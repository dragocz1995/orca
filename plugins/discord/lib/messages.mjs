...
export const MESSAGES = {
  en: {
    ...
    displaySet: (d) => `🎛️ Display: tools **${d.toolActivity}** · answer **${d.answerMode}** · output **${d.toolOutput}**.`,
  ...
  cs: {
    ...
    displaySet: (d) => `🎛️ Zobrazení: nástroje **${d.toolActivity}** · odpověď **${d.answerMode}** · výstup **${d.toolOutput}**.`,
