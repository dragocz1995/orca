...
export function StatsView() {
  ...
  if (usage.isLoading) return <div className="mx-auto w-full max-w-4xl"><LoadingState variant="cards" /></div>;
  if (usage.isError) {
    return <div className="mx-auto w-full max-w-4xl"><ErrorState message={t.common.daemonUnreachable} onRetry={() => usage.refetch()} /></div>;
  }
