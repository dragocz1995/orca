import { Boxes, Plug, SlidersHorizontal, BrainCircuit, Database, Puzzle, Bot, Github, Server, Trash2, type LucideIcon } from 'lucide-react';
...
export const SETTINGS_CATEGORY_VALUES = ['models', 'providers', 'defaults', 'brain', 'memory', 'plugins', 'autopilot', 'github', 'system', 'data'] as const;
