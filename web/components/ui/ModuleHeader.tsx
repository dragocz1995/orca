...
export function ModuleHeader({ title, count, icon: Icon, children }: { title: string; count?: number; icon?: LucideIcon; children?: ReactNode }) {
  return (
    <div className="sticky top-12 z-20 -mx-4 -mt-4 mb-5 flex flex-wrap items-center gap-x-3 gap-y-2 border-b border-border bg-bg/80 px-4 py-3 backdrop-blur md:top-0">
