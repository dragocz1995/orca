...
export function ModuleHeader({ title, count, icon: Icon, children }: { title: string; count?: number; icon?: LucideIcon; children?: ReactNode }) {
  return (
    <div className="z-20 -mx-4 -mt-4 mb-5 flex flex-col gap-2 border-b border-border bg-bg/80 px-4 py-3 backdrop-blur md:sticky md:top-0 md:flex-row md:flex-wrap md:items-center md:gap-x-3">
