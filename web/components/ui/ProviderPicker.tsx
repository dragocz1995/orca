 ...
 *  never silently lost. */
export function ProviderPicker({ providers, value, onChange, label, emptyText, size = 'md' }: {
  ...
  return <Segmented aria-label={label} options={options} value={value} onChange={onChange} size={size} />;
}
