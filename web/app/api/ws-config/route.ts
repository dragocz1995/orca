...
// WebSocket. In proxy-less IP mode the install sets ORCA_WS_DIRECT_PORT to the daemon's public port, so
...
export function GET(): Response {
  const raw = process.env.ELOWEN_WS_DIRECT_PORT ?? process.env.ORCA_WS_DIRECT_PORT;
