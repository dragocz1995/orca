...
describe('DashboardView', () => {
  ...
  it('renders the daily journal and hero cosmos signals with live agent work in the hero', async () => {
    ...
    expect(screen.getByRole('navigation', { name: 'Attention' })).toBeTruthy();
