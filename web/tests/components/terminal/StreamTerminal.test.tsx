...
vi.mock('@xterm/xterm', () => ({
  Terminal: class { open = vi.fn(); write = writeSpy; clear = vi.fn(); dispose = vi.fn(); loadAddon = vi.fn(); cols = 80; rows = 24; onData = (fn: (d: string) => void) => { onDataHandler = fn; return { dispose: vi.fn() }; }; },
}));
