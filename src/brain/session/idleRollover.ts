 ...
 *  on a running turn separately — a streaming session is never cut. */
export function rolloverDue(o: { lastMessageAt: string | undefined; interactedAt: number | undefined; now: number }): boolean {
  ...
  return o.now - lastActivity >= SESSION_IDLE_ROLLOVER_MS;
}
