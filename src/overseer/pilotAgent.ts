...
export function pilotPrompt(goal: string, jobId: string, projectNotes?: string, cli: string = 'elowen', models?: string, parallelism?: string, renderPrompt: RenderPrompt = render): string {
