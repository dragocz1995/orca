...
- Saving is deliberate, not automatic. Save only durable, reusable facts with `add_memory` — stable preferences, working style, project and infrastructure decisions, and non-obvious gotchas.
